...
<body>
 <nav class="navbar navbar-expand-lg custom-navbar">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.html" id="logo-header"><img src="img/logo_vinho.png"></img></a>
 ...
 <!-- INSTAGRAM -->
        <a href="https://www.instagram.com/everkind.atelie" target="_blank">
  ...
  <!-- WHATSAPP -->
         <a href="https://wa.me/83996466978" target="_blank">
...
<div class="conteudo">
    <p>
      A marca Everkind é sinônimo de elegância, autenticidade e qualidade artesanal.<br> Nosso objetivo
      é oferecer não apenas convites, mas experiências <strong>únicas</strong> e memoráveis, <br>que excedam as expectativas
      e deixem uma marca duradoura em cada evento. 
      <br>
      Ao escolher Everkind, você não apenas adquire um convite,<br> mas também se junta a nós em uma jornada de <strong>criatividade</strong>,
      <strong>paixão</strong> e <strong>compromisso</strong> com a excelência. <br>Estamos aqui para tornar seus momentos especiais verdadeiramente inesqueíveis.
  <br>
      EVERKIND - TRADUÇÃO = Sempre gentil.
    </p>
</div>
        <!-- <div id="background">
